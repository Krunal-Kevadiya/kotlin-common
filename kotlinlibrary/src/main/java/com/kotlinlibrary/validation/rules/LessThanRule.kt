...
class LessThanRule<ErrorMessage>(
    ...
    override fun getErrorMessage(): ErrorMessage? {
        return when {
            ...
            typed(kotlin.String::class.java, java.lang.String::class.java) -> "Should be less than $target." as ErrorMessage
            typed(kotlin.Int::class.java, java.lang.Integer::class.java) -> R.string.vald_should_be_less_than_target as ErrorMessage
            else -> throw MismatchErrorTypeException()
        }
    }
