...
class GreaterThanOrEqualRule<ErrorMessage>(
    ...
    override fun getErrorMessage(): ErrorMessage? {
        return when {
            ...
            typed(kotlin.String::class.java, java.lang.String::class.java) -> "Should be greater than or equal to $target." as ErrorMessage
            typed(kotlin.Int::class.java, java.lang.Integer::class.java) -> R.string.vald_should_be_greater_than_or_equal_to_target as ErrorMessage
            else -> throw MismatchErrorTypeException()
        }
    }
