    ...
    sealed class Some<out T>(val code: Int, val headers: Headers? = null, val errorBody: T? = null)
        ...
        sealed class Informational1XX<out T>(code: Int, headers: Headers? = null, errorBody: T? = null)
            ...
            class Continue100<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = Continue100(headers, errorBody?.let { map(it) })
            ...
            class SwitchingProtocols101<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = SwitchingProtocols101(headers, errorBody?.let { map(it) })
            ...
            class Processing102<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = Processing102(headers, errorBody?.let { map(it) })
            ...
            class EarlyHints103<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = EarlyHints103(headers, errorBody?.let { map(it) })
        ...
        sealed class Success2XX<out T>(code: Int, headers: Headers? = null)
            ...
            class Ok200<T>(headers: Headers? = null, val body: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = Ok200(headers, body?.let { map(it) })
            ...
            class Created201<T>(headers: Headers? = null, val body: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = Created201(headers, body?.let { map(it) })
            ...
            class Accepted202<T>(headers: Headers? = null, val body: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = Accepted202(headers, body?.let { map(it) })
            ...
            class NonAuthoritativeInformation203<T>(headers: Headers? = null, val body: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = NonAuthoritativeInformation203(headers, body?.let { map(it) })
            ...
            class NoContent204<out T>(headers: Headers? = null, val body: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = NoContent204(headers, body?.let { map(it) })
            ...
            class ResetContent205<out T>(headers: Headers? = null, val body: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = ResetContent205(headers, body?.let { map(it) })
            ...
            class PartialContent206<T>(headers: Headers? = null, val body: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = PartialContent206(headers, body?.let { map(it) })
            ...
            class MultiStatus207<T>(headers: Headers? = null, val body: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = MultiStatus207(headers, body?.let { map(it) })
            ...
            class AlreadyReported208<T>(headers: Headers? = null, val body: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = AlreadyReported208(headers, body?.let { map(it) })
            ...
            class IMUsed226<T>(headers: Headers? = null, val body: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = IMUsed226(headers, body?.let { map(it) })
        ...
        sealed class Redirection3XX<out T>(code: Int, headers: Headers? = null, errorBody: T? = null)
            ...
            class MultipleChoices300<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = MultipleChoices300(headers, errorBody?.let { map(it) })
            ...
            class MovedPermanently301<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = MovedPermanently301(headers, errorBody?.let { map(it) })
            ...
            class Found302<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = Found302(headers, errorBody?.let { map(it) })
            ...
            class SeeOther303<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = SeeOther303(headers, errorBody?.let { map(it) })
            ...
            class NotModified304<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = NotModified304(headers, errorBody?.let { map(it) })
            ...
            class UseProxy305<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = UseProxy305(headers, errorBody?.let { map(it) })
            ...
            class TemporaryRedirect307<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = TemporaryRedirect307(headers, errorBody?.let { map(it) })
            ...
            class PermanentRedirect308<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = PermanentRedirect308(headers, errorBody?.let { map(it) })
        ...
        sealed class ClientError4XX<out T>(code: Int, headers: Headers? = null, errorBody: T? = null)
            ...
            class BadRequest400<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = BadRequest400(headers, errorBody?.let { map(it) })
            ...
            class Unauthorized401<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = Unauthorized401(headers, errorBody?.let { map(it) })
            ...
            class PaymentRequired402<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = PaymentRequired402(headers, errorBody?.let { map(it) })
            ...
            class Forbidden403<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = Forbidden403(headers, errorBody?.let { map(it) })
            ...
            class NotFound404<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = NotFound404(headers, errorBody?.let { map(it) })
            ...
            class MethodNotAllowed405<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = MethodNotAllowed405(headers, errorBody?.let { map(it) })
            ...
            class NotAcceptable406<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = NotAcceptable406(headers, errorBody?.let { map(it) })
            ...
            class ProxyAuthenticationRequired407<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = ProxyAuthenticationRequired407(headers, errorBody?.let { map(it) })
            ...
            class RequestTimeout408<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = RequestTimeout408(headers, errorBody?.let { map(it) })
            ...
            class Conflict409<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = Conflict409(headers, errorBody?.let { map(it) })
            ...
            class Gone410<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = Gone410(headers, errorBody?.let { map(it) })
            ...
            class LengthRequired411<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = LengthRequired411(headers, errorBody?.let { map(it) })
            ...
            class PreconditionFailed412<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = PreconditionFailed412(headers, errorBody?.let { map(it) })
            ...
            class PayloadTooLarge413<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = PayloadTooLarge413(headers, errorBody?.let { map(it) })
            ...
            class URITooLong414<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = URITooLong414(headers, errorBody?.let { map(it) })
            ...
            class UnsupportedMediaType415<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = UnsupportedMediaType415(headers, errorBody?.let { map(it) })
            ...
            class RangeNotSatisfiable416<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = RangeNotSatisfiable416(headers, errorBody?.let { map(it) })
            ...
            class ExpectationFailed417<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = ExpectationFailed417(headers, errorBody?.let { map(it) })
            ...
            class ImATeapot418<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = ImATeapot418(headers, errorBody?.let { map(it) })
            ...
            class EnhanceYourCalm420<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = EnhanceYourCalm420(headers, errorBody?.let { map(it) })
            ...
            class MisdirectedRequest421<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = MisdirectedRequest421(headers, errorBody?.let { map(it) })
            ...
            class UnprocessableEntry422<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = UnprocessableEntry422(headers, errorBody?.let { map(it) })
            ...
            class Locked423<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = Locked423(headers, errorBody?.let { map(it) })
            ...
            class FailedDependency424<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = FailedDependency424(headers, errorBody?.let { map(it) })
            ...
            class TooEarly425<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = TooEarly425(headers, errorBody?.let { map(it) })
            ...
            class UpgradeRequired426<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = UpgradeRequired426(headers, errorBody?.let { map(it) })
            ...
            class PreconditionRequired428<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = PreconditionRequired428(headers, errorBody?.let { map(it) })
            ...
            class TooManyRequests429<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = TooManyRequests429(headers, errorBody?.let { map(it) })
            ...
            class RequestHeaderFieldsTooLarge431<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = RequestHeaderFieldsTooLarge431(headers, errorBody?.let { map(it) })
            ...
            class NoResponse444<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = NoResponse444(headers, errorBody?.let { map(it) })
            ...
            class RetryWith449<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = RetryWith449(headers, errorBody?.let { map(it) })
            ...
            class BlockedByWindowsParentalControls450<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = BlockedByWindowsParentalControls450(headers, errorBody?.let { map(it) })
            ...
            class UnavailableForLegalReasons451<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = UnavailableForLegalReasons451(headers, errorBody?.let { map(it) })
            ...
            class ClientClosedRequest499<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = ClientClosedRequest499(headers, errorBody?.let { map(it) })
        ...
        sealed class ServerError5xx<out T>(code: Int, headers: Headers? = null, errorBody: T? = null)
            ...
            class InternalServerError500<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = InternalServerError500(headers, errorBody?.let { map(it) })
            ...
            class NotImplementedError501<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = NotImplementedError501(headers, errorBody?.let { map(it) })
            ...
            class BadGateway502<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = BadGateway502(headers, errorBody?.let { map(it) })
            ...
            class ServiceUnavailable503<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = ServiceUnavailable503(headers, errorBody?.let { map(it) })
            ...
            class GatewayTimeout504<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = GatewayTimeout504(headers, errorBody?.let { map(it) })
            ...
            class HTTPVersionNotSupported505<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = HTTPVersionNotSupported505(headers, errorBody?.let { map(it) })
            ...
            class VariantAlsoNegotiates506<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = VariantAlsoNegotiates506(headers, errorBody?.let { map(it) })
            ...
            class InsufficientStorage507<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = InsufficientStorage507(headers, errorBody?.let { map(it) })
            ...
            class LoopDetected508<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = LoopDetected508(headers, errorBody?.let { map(it) })
            ...
            class BandwidthLimitExceeded509<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = BandwidthLimitExceeded509(headers, errorBody?.let { map(it) })
            ...
            class NotExtended510<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = NotExtended510(headers, errorBody?.let { map(it) })
            ...
            class NetworkAuthenticationRequired511<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = NetworkAuthenticationRequired511(headers, errorBody?.let { map(it) })
            ...
            class NetworkReadTimeoutError598<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = NetworkReadTimeoutError598(headers, errorBody?.let { map(it) })
            ...
            class NetworkConnectTimeoutError599<out T>(headers: Headers? = null, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = NetworkConnectTimeoutError599(headers, errorBody?.let { map(it) })
        ...
        sealed class UnknownError<out T>(code: Int, headers: Headers? = null, errorBody: T? = null)
            ...
            class UnknownRequired<out T>(code: Int, headers: Headers? = null, val body: T, errorBody: T? = null)
                ...
                override fun <R> map(map: ((T) -> R)) = UnknownRequired(code, headers, map(body), errorBody?.let { map(it) })
                override fun toString() = "UnknownRequired(headers=$headers)"
            }

            class NetworkError<out T>(headers: Headers? = null, errorBody: T? = null)
                : UnknownError<T>(HttpStatusCode.NETWORK_ERROR, headers, errorBody) {
                override fun <R> map(map: ((T) -> R)) = NetworkError(headers, errorBody?.let { map(it) })
                override fun toString() = "NetworkError(headers=$headers)"
            }
        }
    }
}
